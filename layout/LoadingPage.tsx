...
const Sibling = ({ isSibling }: { isSibling?: boolean }) => {
  return (
    <span
      className={dsnCN("dsnload__row", isSibling && "dsnload__row--sibling")}
    >
      <span className="dsnload__img">{/* <Logo /> */}</span>
    </span>
  );
};
    ...
    const handleLoad = () => {
      ...
      tl.to(present, 1, {
        ...
        .fromTo(
          ...
          1,
          { y: 400 },
          { y: 0, clearProps: "y", ease: "Expo.easeInOut" },
          "-=1.2"
        )
        .call(function () {
          setRemove(true);
    ...
    >
      ...
      >
        ...
        <path
          ...
          style={{ strokeDashoffset: 300 - progressValue * 3 }}
      ...
      >
        <div className="loading-circle v-middle">
          <div className="loading-count v-middle">
            {" "}
            <Logo width="200px" height="auto" />
          </div>
        </div>

        <div className="loading-text dsn-container">
          <span>ESAR Paper Industries Limited</span>
        </div>
      </div>
