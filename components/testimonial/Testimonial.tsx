...
interface TestimonialProps extends SwiperOptions {
  ...
  skin?:
    | []
    | ["testimonials-half" | "testimonials-personal" | "box-line" | "box-half"];
}
...
function Testimonial({
  ...
  useEffect(() => {
    const nav = testimonials.current.querySelector(
      ".testimonial-nav .swiper"
    )?.swiper;
    const content = testimonials.current.querySelector(
  ...
  return (
    <section
      className={dsnCN(
        ...
        skin?.join(" ").trim(),
        className,
        title && "testimonials-with-title"
      )}
      ref={testimonials}
    >
      <div
        className={dsnCN(
          "testimonials-box  box-padding p-relative w-100",
          backgroundColor
        )}
      >
        {title && (
        ...
        <div className="testimonials-inner p-relative">
                ...
                {TestimonialDetails.map(($item, $index) => (
                  ...
                  >
                    ...
                    <div className="box-text" {...parallaxContent}>
                      <h4 className="title-block testimonial-name">
                        {$item.name}
                      </h4>
                      <h5 className="sm-title-block testimonial-description">
                        {$item.label}
                      </h5>
                    </div>
                  </SwiperSlide>
          ...
          <div className="testimonial-content ">
            <Swiper
              modules={[Pagination, Controller, Parallax]}
              parallax
