...
export const ServiceGrid = ({
  ...
  useEffect(() => {
    ...
    // @ts-ignore
    const isotope = new Isotope(iso.current.querySelector(".dsn-grid-layout"), {
  ...
  if (masonry)
    return (
      <div className={dsnCN("dsn-isotope ", className)} ref={iso}>
        <Service
          className={"dsn-grid-masonry"}
          iconOption={iconOption}
          {...props}
          tag={DsnGrid}
        />
