  ...
  return (
    <DsnGrid col={2} colTablet={1} colGap={0} rowGap={0} rowGapTablet={60}>
      ...
      <div className="box-info box-padding p-md-0 ">
        ...
        >
          {heroData.title}, <br />
          <span style={{ color: "#dbc768" }}>
            ESAR Paper <br /> Industries Ltd
          </span>
        </TitleSection>
        ...
        <DsnGrid
          ...
          col={2}
        >
          {heroData.infoPersonal &&
            heroData.infoPersonal.map((item, index) => (
              <li key={index}>
